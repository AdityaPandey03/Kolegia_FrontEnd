...
export const getAllRequirements = () => async (dispatch) => {
  ...
  export const addRequirements= (title,description,token)=> async (dispatch) => {
  ...
  export const getAllOwnRequirements = () => async (dispatch) => {
    ...
    export const editRequirements= (requirement_id,title,description,token)=> async (dispatch) => {
